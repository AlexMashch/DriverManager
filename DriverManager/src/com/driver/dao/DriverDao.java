...
public class DriverDao {
	...
	public boolean addDri(Driver driver) {
		...
		return jdbcTemplate.update(sql,
				new Object[] { driver.getId(),driver.getName(), driver.getMile() ,driver.getPost(),driver.getCode(),driver.getPrefecture(),driver.getCity(),driver.getTown()},
				new int[] { Types.VARCHAR,Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR }) == 1;
	}
	public boolean updateDriver(Driver driver) {
		String sql ="update driver set name=?,mile=?,post=?,code=?,prefecture=?,city=?,town=? where id=?" ;
		Object driObj[] = new Object[] { driver.getName(), driver.getMile() ,driver.getPost(),driver.getCode(),driver.getPrefecture(),driver.getCity(),driver.getTown(),driver.getId()};
